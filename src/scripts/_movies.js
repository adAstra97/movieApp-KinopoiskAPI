...
async function openModal(id) {
   let resp = await fetch(API_URL_MOVIE_DETAILS + id, {
      headers: {
         'Content-Type': 'application/json',
         'X-API-KEY': API_KEY,
      },
   ...
   <div class="modal__card">
      ...
      <h2>
         <span class="modal__movie-title">${respData.nameRu || respData.nameEn || respData.nameOriginal}</span>
   ...
   `;
   let btnClose = modalEl.querySelector('.modal__button-close');
